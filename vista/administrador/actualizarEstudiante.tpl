    ...
    <body>
        ...
        <form action="/colegio/administrador/guardar" method="post" name="form1">
            <table width="416" border="1" cellspacing="0" cellpadding="2">
                <tr>
                    <th width="197" scope="row">ACTUALIZAR ESTUDIANTE</th>
                    <td width="211"><input name="idEstudiantes" id="idEstudiantes" type="text" /></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="2"><input name="actualizarEstudiantes" id="actualizarEstudiantes" type="submit" value="Actualizar" /></td>
                </tr>
