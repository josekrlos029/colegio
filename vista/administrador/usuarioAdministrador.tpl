...
<hr>
	...
	<tr>
    <td> <td align="right" width="10%"><a href="#"><img src="../utiles/imagenes/iconos/inicio.png"/></a></td></td>
...
<hr>
	   ...
	   <tr>
	   <td align="center" width="30%"><div id="box" class="green"><img src="../utiles/imagenes/admin.png"/></div></td>
	    <td></td>
