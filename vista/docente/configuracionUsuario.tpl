 ...
 var password = document.getElementById("password");
    ...
    x.html ( "<p>Error: Tiene Campos Requeridos Vacios</p>");
      ...
      ocultar();
        ...
        var url="/colegio/docente/configurarUsuario/";
        ...
        case 1:
         ...
         exito();
         ocultar();
         document.location.href="/colegio/docente/configuracionUsuario";
        break;
...
var confPasswordNew = document.getElementById("confPasswordNew");
  ...
  if (idPersona.value=="" || passwordActual.value=="" || passwordNew.value=="" || confPasswordNew.value=="" ){
            ...
            var url="/colegio/docente/configurarContraseña/";
...
var passwordC = document.getElementById("passwordC");
 ...
 if (idPersona.value=="" || correo.value=="" || passwordC.value==""){
            ...
            var url="/colegio/docente/configurarCorreo/";
...
<li>
                ...
                <tr>
                    <td></td>
                    <td colspan="2"><input name="configurarUsuario" id="configurarUsuario" type="submit" class="button large red" value="Guardar" onclick="envioUser()" /></td>
                </tr>
               </table>
...
<li>
 <table width="80%" border="0" cellspacing="0" cellpadding="2">
                ...
                <tr>
                    <td></td>
                    <td colspan="2"><input name="configurarContraseña" id="configurarContraseña" type="submit" class="button large red" value="Guardar" onclick="envioPassword()" /></td>
                </tr>
</table>
</li>
...
<li>
    <table width="80%" border="0" cellspacing="1" cellpadding="2">
                ...
                <tr>
                    <td></td>
                    <td colspan="2"><input name="configurarEmail" id="configurarEmail" type="submit" class="button large red" value="Guardar" onclick="envioEmail()" /></td>
                </tr>
               </table>  
