            ...
            public function cargarLogros(){
                try {
                    ...
                    $respuesta = "<tr> 
                                  ...
                                  <tr> 
                                        <td align='center'><textarea id='superior' maxlength='213' autofocus placeholder='Aquí debes escribir el Logro Superior' rows='4' cols='60'  >".$superior."</textarea> </td>
                                  </tr>
                                  <tr> 
                                        <td align='center'><h5>Logro Alto </h5> </td>
                                  </tr>
                                  <tr> 
                                        <td align='center'><textarea id='alto' maxlength='213' placeholder='Aquí debes escribir el Logro Alto' rows='4' cols='60'  >".$alto."</textarea> </td>
                                  </tr>
                                  <tr> 
                                        <td align='center'><h5>Logro Basico </h5> </td>
                                  </tr>
                                  <tr> 
                                       <td align='center'><textarea id='basico' maxlength='213' placeholder='Aquí debes escribir el Logro Basico' rows='4' cols='60'  >".$basico."</textarea> </td>
                                  </tr>
                                  <tr> 
                                        <td align='center'><h5>Logro Bajo </h5> </td>
                                  </tr>
                                  <tr> 
                                       <td align='center'><textarea id='bajo' maxlength='213' placeholder='Aquí debes escribir el Logro Bajo' rows='4' cols='60'  >".$bajo."</textarea> </td>
                                  </tr>
                                  <tr> 
